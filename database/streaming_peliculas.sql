...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-10-2023 a las 04:59:16
...
(9, 'Better Call Saul', 'Ambientada en 2002, seis años antes de los acontecimientos relatadas en Breaking Bad, Better Call Saul es un spin-off centrado en el personaje de James &#039;Jimmy&#039; McGuill (Bob Odenkirk), antes de que asuma la identidad de Saul Goodman, un abogado corrupto con un humor políticamente incorrecto vinculado al mundo criminal que empieza a crear una importante red de contactos en los bajos mundos. La serie narra los acontecimientos que llevan a McGuill a convertirse en Saul antes de trabajar co', 'Vince Gilligan', '2015-02-08', 'Bob Odenkirk, Sea Reehorn, etc', 2, 'https://www.aceprensa.com/wp-content/uploads/2015/10/60059-1.jpg'),
...
(2, 'Netflix', 'https://www.netflix.com/ar/', 'Series, Peliculas, Documentales', 1, 5000, 'https://images.ctfassets.net/y2ske730sjqp/6bhPChRFLRxc17sR8jgKbe/6fa1c6e6f37acdc97ff635cf16ba6fb3/Logos-Readability-Netflix-logo.png'),
